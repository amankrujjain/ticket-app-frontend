...
export default function TicketTable() {
  return (
    <ul className="divide-y px-7 divide-gray-100">
      {people.map((person, index) => (
        <div key={person.email}>
          <li className="flex flex-col sm:flex-row justify-between gap-x-6 py-5">
            ...
            <div className="flex flex-col sm:flex-col sm:items-end mt-4 sm:mt-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end mt-4 sm:mt-0 gap-y-2 sm:gap-y-0 sm:gap-x-4">
          ...
          {index < people.length - 1 && <hr className="my-5" />}{" "}
          {/* Adds an <hr /> between each item except the last one */}
        </div>
      ))}
    </ul>
  );
